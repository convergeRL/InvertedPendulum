...
class Actor(object):
    ...
    def __init__(self, state_dim, action_dim, low, high):
        ...
        self.action_taken = tf.placeholder(tf.float32,[None, self.action_dim])
        ...
        self.action_sample = self.action
        ...
        self.loss = -tf.reduce_sum(logprob*self.advantage)
...
#        
    ...
    def predict(self, state):
        ...
        """
        #print "Predicting..."
        return self.sess.run(self.action_sample, feed_dict = {
            self.state : state
        })
